<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homes.aspx.cs" Inherits="GameStore.Pages.Admin.Games"
    MasterPageFile="~/Pages/Admin/Admin.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="TheOuterWoldShopHome.Models.Home" SelectMethod="GetGames"
        DataKeyNames="HomeId" UpdateMethod="UpdateHome" DeleteMethod="DeleteHome"
        InsertMethod="InsertHome" InsertItemPosition="LastItem" EnableViewState="false"
        runat="server">
        <LayoutTemplate>
        ...
        <EditItemTemplate>
            <tr>
                <td>
                    ...
                    <input type="hidden" name="ProductID" value="<%# Item.HomeId %>" />
                </td>
                <td>
